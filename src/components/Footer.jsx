...
const Footer = () => {
  return (
    <div className="w-full h-screen flex bg-black rounded-3xl px-10 pt-10 pb-3">
      <div className="w-1/2 h-full flex flex-col items-start justify-between font-[founders]">
        <div className="headings">
          <h1 className="text-[9vw] uppercase -mb-24">eye-</h1>
          <h1 className="text-[9vw] uppercase -mb-24">opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 h-full ">
        <h1 className="text-[9vw] font-[founders] font-bold uppercase">
          presentations
        </h1>
        ...
        <div className="loca flex items-center justify-between mt-10 capitalize">
          <div className="mb-16">
            <h5>202-1965 W 4th Ave</h5>
            <h5>Vancouver, Canada</h5>
            <h5>30 Chukarina St</h5>
            <h5>Lviv, Ukraine</h5>
          </div>
        ...
        <h5>Hello@Ochiiii.design</h5>
        <div className="mt-5 flex justify-between">
        <h4 className="text-zinc-700">© ochi design 2024. Legal Terms</h4>
        <h4 className="text-zinc-700">Website by Obys</h4>
        </div>
      </div>
    </div>
  );
